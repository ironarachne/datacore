            ...
            <div class="col-md-8">
                ...
                <form id="pattern-edit-form" method="POST" action="{{ route('pattern.update', ['pattern' => $pattern]) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name_template" name="name_template" class="form-control" v-pre value="{{ $pattern->name_template }}">
                    </div>
                    <div class="form-group">
                        <label for="description">Description</label>
                        <input type="text" id="description" name="description" class="form-control" value="{{ $pattern->description }}">
                    </div>
                    <div class="form-group">
                        <label for="main_material_override">Main Material Override</label>
                        <input type="text" id="main_material_override" name="main_material_override" class="form-control" value="{{ $pattern->main_material_override }}">
                    </div>
                    <div class="form-group">
                        <label for="origin_override">Origin Override</label>
                        <input type="text" id="origin_override" name="origin_override" class="form-control" value="{{ $pattern->origin_override }}">
                    </div>
                    <div class="form-group">
                        <label for="commonality">Commonality</label>
                        <input type="number" id="commonality" name="commonality" class="form-control" value="{{ $pattern->commonality }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select multiple id="professions" name="professions[]" class="form-control">
                            @foreach($professions as $profession)
                                <option value="{{ $profession->id }}" @if($pattern->professions->contains($profession->id))selected @endif>{{ $profession->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
