            ...
            <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="{{ route('biome.index') }}" :active="request()->routeIs('biome.index')">
                                    Biomes
                                </x-jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="{{ route('charge.index') }}" :active="request()->routeIs('charge.index')">
                                    Charges
                                </x-jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="{{ route('mineral.index') }}" :active="request()->routeIs('mineral.index')">
                                    Minerals
                                </x-jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="{{ route('pattern.index') }}" :active="request()->routeIs('pattern.index')">
                                    Patterns
                                </x-jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="{{ route('resource.index') }}" :active="request()->routeIs('resource.index')">
                                    Resources
                                </x-jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="{{ route('species.index') }}" :active="request()->routeIs('species.index')">
                                    Species
                                </x-jet-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <x-jet-responsive-nav-link href="{{ route('biome.index') }}" :active="request()->routeIs('biome.index')">
                            Biomes
                        </x-jet-responsive-nav-link>
                    </div>
