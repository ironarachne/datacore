<x-app-layout>
    ...
    <div>
        ...
        @if (Auth::user()->is_admin)
            <p class="flex">
                <a href="{{ route('species.create') }}" class="btn">Create New</a>
                <a href="{{ route('species.json') }}" class="btn">Create from JSON</a>
                <a href="{{ route('species.quick') }}" class="btn">Create Quick Race</a>
            </p>
        @endif
